...
#     # Record purchase
#     cursor.execute("INSERT INTO purchases (user_id, product_id) VALUES (?, ?)", (session['user_id'], product_id))
...
#     data = request.json
#     return jsonify({"success": True, "message": f"Purchase successful for product ID: {data['product_id']}"})
